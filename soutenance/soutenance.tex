...
\end{center}
    ...
    \begin{block}{ZMAP}
	\begin{itemize}
		\item open source dévoloppé par l'équipe de l'Université du Michigan ;
...
\end{center}
	...
	\begin{block}{Certificats mal formés}
		\begin{itemize}
			\item \textit{Common Name} vide : validation impossible au regard du nom de domaine ;
			\item \textit{Serial Number} seul : absence d'informations sur le certificat.\\
		\end{itemize}
	\end{block}
}
