...
\frame{
\frametitle{Chiffrement et protocoles 1}
...
\frame{
\frametitle{Chiffrement et protocoles 2}
...
\frame{
\frametitle{Chiffrement et protocoles 3}
	\begin{block}{CBC}
		\begin{figure}[H]
			\centering
			\includegraphics[width=6cm]{CBC_chiff.png}
			\label{CBC_chiff}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6cm]{CBC_dechiff.png}
			\label{CBC_dechiff}
		\end{figure}
	\end{block}
}
...
\frame{
\frametitle{Chiffrement et protocoles 4}
