...
\begin{enumerate}
	\item [EO.X] : Lors de la récupération des certificats, les protocoles visés seront SSL/TLS (cf UC1). SSH est laissé de côté après plusieurs plaintes d'Amazone.
\end{enumerate}
...
\begin{enumerate}
	...
	\item [EQ.2] : Présentation des résultats sous forme de formulaires, dont la maquette est ci-jointe.
\end{enumerate}
