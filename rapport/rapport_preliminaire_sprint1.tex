...
Enfin, avec tous les moduli que nous avions extraits, nous avons pu construire deux arbres permettant de définir si des moduli contiennent des facteur premiers communs.
